...
#define REPORTING_PERIOD_MS 1000   //stan_ it doesn't be used now.
#define httpposting_MS 10000
...
/*
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    /*
      if (millis() - tsLastReport > httpposting_MS) {    //stan_every 10 seconds post to servelet
      ...
      // Send HTTP POST request...........?????????? the sensor broke by post
